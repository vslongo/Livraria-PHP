...
<body class="bg-fundo text-light">
    ...
    <main>
        <div class="Form-Cadastro d-flex justify-content-center bg-principal text-light my-5">
            <form action="cadastrar_livros.php" method="POST" class="row mx-2" enctype="multipart/form-data">
                ...
                <div class="col-6 mb-2">
                    ...
                    <input type="text" name="titulo" id="titulo" placeholder="Titulo:" required class="form-control">
                </div>
                <!-- titutlo -->
                ...
                <div class="col-6">
                    ...
                    <input type="text" name="autor" id="autor" placeholder="Autor:" required class="form-control">
                </div>
                <!-- autor -->
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="isbn" id="isbn" placeholder="ISBN:" required class="form-control">
                </div>
                <!-- ISBN -->
                ...
                <div class="col-6">
                    ...
                    <input type="text" name="editora" id="editora" placeholder="Editora:" required class="form-control">
                </div>
                <!-- editora -->
                ...
                <div class="col-6">
                    ...
                    <input type="text" name="edicao" id="edicao" placeholder="Edição:" required class="form-control">
                </div>
                <!-- edição -->
                ...
                <div class="col-6 mb-2">
                    ...
                    <input type="date" name="data" id="data" placeholder="" required class="form-control">
                </div>
                <!-- data -->
                ...
                <div class="col-6">
                    ...
                    <input type="text" name="valor" id="valor" placeholder="Valor:" required class="form-control">
                </div>
                <!-- Valor -->
                ...
                <div class="col-12 mb-2">
                    ...
                    <input type="text" name="text" id="text rows='3'" placeholder="Resumo:" required class="form-control h-100"> 
                </div>
                ...
                <div class="col-12 mt-5">
                    ...
                    <input type="file" id="capa" class="input-padrao" name="capa" require="true"> 
                </div>
                <!-- capa -->
